...
@WebServlet("/BoardSingleController")
public class BoardSingleController extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public BoardSingleController() {
        super();
    }
	...
	protected void actionDo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("BoardSingleController의 actionDo 실행");
		...
		try {
			...
			int board_idx = Integer.parseInt(request.getParameter("idx").trim());
			...
			likes = (mvo != null) ? likeDao.selectLike(board_idx, mvo.getId()) : false;
		...
		String url = "/board/board-single.jsp";
