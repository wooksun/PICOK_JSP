...
/**
 * Servlet implementation class BoardSingleUpdateController
 */
@WebServlet("/BoardUpdate.do")
public class BoardSingleUpdateController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardSingleUpdateController() {
        super();
    }
