...
public class List2Controller extends HttpServlet {
	...
	protected void actionDo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("list2(인기순정렬)가져오는 컨트롤러 에서 actiondo 하는 중 ");
		//	여기까지 console에 찍힘 
		...
		BoardService boardService = BoardService.getInstance();
		  ...
		  BoardList boardList = boardService.selectListbyPopular(category, currentPage);
		  
		  System.out.println("좋아요정렬"+boardList);
