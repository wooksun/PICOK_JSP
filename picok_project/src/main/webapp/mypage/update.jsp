...
<body>
	...
	<%
	//   update.jsp에서 넘겨받은 정보를 MemberVO 객체 생성하여 수정된 정보 저장
	...
	<section class="bg-light py-5">
		<div class="container my-4">
			...
			<div class="row d-flex flex-row">
				...
				<!-- 프로필 정보 -->
				<form action="../UpdateMember?id=${sessionScope.mvo.id} "
					method="POST" align="center">
					<div class="row d-flex flex-row">
						<div class="col-lg-5 m-auto">
							<div class="row">
								아이디<input value="${sessionScope.mvo.id}" disabled="disabled" type="text" name="id" style="margin: 10px;" required="required">
								이름<input value="${sessionScope.mvo.name}" disabled="disabled" type="text" name="name" style="margin: 10px;" required="required">
								비밀번호<input value="" placeholder="숫자/대문자/소문자/특수문자를 모두 포함하여 8자 이상" type="password" id="password1" name="password1" style="margin: 10px;" required="required" onchange="passwordCheckFunction()">
								비밀번호확인
