...
<body>
	...
	<div class="col-lg-5 m-auto">
		<form action="../upload.do" method="post"
			...
			<br />
			<div>
				<input type="file" name="filename" onchange="photoView(event)"
					accept="image/*"><br /> <br />
			</div>
			...
			<div class="form-group">
				<label for="subject">제목${subject}</label> <input type="text"
			...
			<textarea class="form-control" id="content" name="content" rows="3" style="resize: none;">사진정보를 담아 내용을 입력하세요.</textarea>
			</div>
