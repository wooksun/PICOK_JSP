         ...
         <table class="table"
            style="text-align: center;"><br/><br/>
               <tr>
				<td style="text-align:left; margin-left:10px; width: 120px; vertical-align: middle;"><h6>아이디</h6></td>
                  <td><input class="form-control" type="text" id="id" name="id"
                     ...
                     onkeydown="if (event.keyCode === 13) registerCheckFunction()"></td>
                  <td class="info"
                     style="border:none;vertical-align: middle; width: 120px; text-align: center;">
                     <button class="btn btn-outline-info" type="button"
                        onclick="registerCheckFunction()">중복검사</button>
                  </td>
               </tr>
               <tr >
                  ...
                  <td><input class="form-control" type="password"
                     ...
                     placeholder="숫자/대문자/소문자/특수문자를 포함해 8자 이상"
                     autocomplete="off" onchange="passwordCheckFunction()"></td>
               </tr>
               <tr>
                  <td style="width: 120px; vertical-align: middle; text-align:left; margin-left:10px; "><h6>비밀번호확인</h6></td>
                  <td><input class="form-control" type="password"
                     id="password2" name="password2" maxLength="20"
                     placeholder=""
                     autocomplete="off" onchange="passwordCheckFunction()"></td>
               </tr>
               <tr>
                  ...
                  <td><input class="form-control" type="text" id="name"
                     name="name" maxLength="20" placeholder=""></td>
               </tr>
               <tr>
                  ...
                  <td><input class="form-control" type="text" id="nickname"
                     name="nickname" maxLength="20" placeholder="" 
                     onkeydown="if (event.keyCode === 13) registerCheckFunction2()"></td>
                  <td class="info"
                     style=" border:none; vertical-align: middle; width: 120px; text-align: center;">
                     <button class="btn btn-outline-info" type="button"
                        onclick="registerCheckFunction2()">중복검사</button>
                  </td>
               </tr>
               <tr>
                  ...
                  <td><input class="form-control" type="text" id="email"
                    name="email" maxLength="20" placeholder=""></td>
               </tr>
               ...
               <tr>
                  ...
                  <td><input class="form-control" type="text" id="phone_num"
                     name="phone_num" maxLength="20" placeholder="핸드폰번호 '-'없이 숫자만 입력하세요."></td>
               </tr>
               <tr>
               ...
               <td colspan="3" style=" border:none; text-align: center;">
                  ...
                  <!-- 닉네임 중복 검사 결과 메시지가 출력될 영역 -->
                  <h6 id="nicknameCheckMessage" style="color: red; font-weight: bold;"></h6>
                  <!-- 오류 메시지가 출력될 영역 -->
           	 	   <h6 id="errorMessage" style="color: blue; font-weight: bold;">
                     <!-- ${messageType}: ${messageContent} -->
                     <!-- ${messageType2}: ${messageContent2}  -->
                  </h6> 
